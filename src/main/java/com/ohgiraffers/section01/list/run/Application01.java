...
public class Application01 {
    ...
    public static void main(String[] args) {
         ...
         *  즉, 데이터는 효율적으로 저장하는 자료구조과 데이터를 처리하는 알고리즘을 미리
         *  인도, 미국 형들이 구현해두었다.
         * */
        ...
        *  하지만 Map 은 구조상의 차이로 Collection 인터페이스에서 정의 하고 있지 않다.
        *
        * 필기.
        *  각 인터페이스 별 특징
        *   1. List 인터페이스
        *       - 순서 있는 데이터의 집합으로 데이터의 중복 저장을 허욯한다.
        *       - Vector, ArrayList, LinkedList, Stack, Queue 등이 있다.
        *   2. Set 인터페이스
        *       - 순서가 없는 데이터의 집합으로 데이터의 중복을 허욯하지 않는다.
        ...
        * */
        ...
        /* 필기.
        *   ArrayList 는 배열의 단점을 보완하기 위해 만들어 졌다.
        ...
        *   래퍼런스 타입은 List 로 해두는게 더 유연한 코드를 작성하는 것이다.
        * */
        List list = new ArrayList<>();           // 웬만하면 이렇게 작성
        ...
        System.out.println("alist = " + alist);    // 값의 순서 유지, 자동으로 overridding 되고 있다.
        ...
        *       단, size() 는 배열의 크기가 아닌 요소의 갯수를 반환한다.*/
        ...
        /* 필기. 원하는 인덱스 위치에 값을 추가하거나 뺄 수 있다.
        *       새로운 값이 들어가는 인덱스 위치에 값을 넣고 인후 인덱스는 하나씩 뒤로 밀리게 된다.
        * */
        alist.add(1,"banana");
        System.out.println("alist = " + alist);
        ...
        alist.set(1,true);
        System.out.println("alist = " + alist);     //autoboxing(레퍼런스를 감싼 값이 들어갔따.)

        List<String>stringList = new ArrayList<>();  // 지정한 타입 이외의 인스턴스는 지정하지 못한다.
//        stringList.add(123);
